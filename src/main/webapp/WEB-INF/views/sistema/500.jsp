...
<head>
    ...
    <title>Erro Interno — UNIHELP</title>
...
<body>
    <div class="error-page error-page-500">
        <div class="error-card">
            ...
            <div class="error-divider error-divider-500"></div>
            <div class="error-title">Erro Interno do Servidor</div>
            <div class="error-desc">
                Ocorreu um erro inesperado no servidor.<br>
                Por favor tente novamente. Se o problema persistir, contacte o administrador.
            </div>
